...
class CodenavAT043 < Formula
  ...
  on_linux do
    url "https://github.com/shaharia-lab/code-navigator/releases/download/v0.4.3/codenav-linux-x86_64.tar.gz"
    sha256 "ead63cefd384aebeb7ff70718d3eb7a334c4b06ad1958d96d263250b0b9a848e"
  end
